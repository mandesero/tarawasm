...
// Package tcpcreatesocket represents the imported interface "wasi:sockets/tcp-create-socket@0.2.3".
package tcpcreatesocket

import (
	"adder-wasm-bindings/internal/wasi/sockets/network"
	"adder-wasm-bindings/internal/wasi/sockets/tcp"
	"go.bytecodealliance.org/cm"
)

// Network represents the imported type alias "wasi:sockets/tcp-create-socket@0.2.3#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/tcp-create-socket@0.2.3#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPAddressFamily represents the type alias "wasi:sockets/tcp-create-socket@0.2.3#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// TCPSocket represents the imported type alias "wasi:sockets/tcp-create-socket@0.2.3#tcp-socket".
//
