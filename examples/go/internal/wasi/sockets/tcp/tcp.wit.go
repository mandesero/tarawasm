...
// Package tcp represents the imported interface "wasi:sockets/tcp@0.2.3".
package tcp

import (
	monotonicclock "adder-wasm-bindings/internal/wasi/clocks/monotonic-clock"
	"adder-wasm-bindings/internal/wasi/io/poll"
	"adder-wasm-bindings/internal/wasi/io/streams"
	"adder-wasm-bindings/internal/wasi/sockets/network"
	"go.bytecodealliance.org/cm"
)

// InputStream represents the imported type alias "wasi:sockets/tcp@0.2.3#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:sockets/tcp@0.2.3#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Pollable represents the imported type alias "wasi:sockets/tcp@0.2.3#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Duration represents the type alias "wasi:sockets/tcp@0.2.3#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// Network represents the imported type alias "wasi:sockets/tcp@0.2.3#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/tcp@0.2.3#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPSocketAddress represents the type alias "wasi:sockets/tcp@0.2.3#ip-socket-address".
//
// See [network.IPSocketAddress] for more information.
type IPSocketAddress = network.IPSocketAddress

// IPAddressFamily represents the type alias "wasi:sockets/tcp@0.2.3#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// ShutdownType represents the enum "wasi:sockets/tcp@0.2.3#shutdown-type".
//
//	enum shutdown-type {
//		receive,
//		send,
...
// TCPSocket represents the imported resource "wasi:sockets/tcp@0.2.3#tcp-socket".
//
//	resource tcp-socket
