...
// Package network represents the imported interface "wasi:sockets/network@0.2.3".
package network
...
// Network represents the imported resource "wasi:sockets/network@0.2.3#network".
//
//	resource network
...
// ErrorCode represents the enum "wasi:sockets/network@0.2.3#error-code".
//
//	enum error-code {
//		unknown,
//		access-denied,
...
// IPAddressFamily represents the enum "wasi:sockets/network@0.2.3#ip-address-family".
//
...
// IPv4Address represents the tuple "wasi:sockets/network@0.2.3#ipv4-address".
//
//	type ipv4-address = tuple<u8, u8, u8, u8>
type IPv4Address [4]uint8

// IPv6Address represents the tuple "wasi:sockets/network@0.2.3#ipv6-address".
//
//	type ipv6-address = tuple<u16, u16, u16, u16, u16, u16, u16, u16>
type IPv6Address [8]uint16

// IPAddress represents the variant "wasi:sockets/network@0.2.3#ip-address".
//
//	variant ip-address {
//		ipv4(ipv4-address),
//		ipv6(ipv6-address),
...
// IPv4SocketAddress represents the record "wasi:sockets/network@0.2.3#ipv4-socket-address".
//
...
// IPv6SocketAddress represents the record "wasi:sockets/network@0.2.3#ipv6-socket-address".
//
...
// IPSocketAddress represents the variant "wasi:sockets/network@0.2.3#ip-socket-address".
//
