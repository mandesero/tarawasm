...
// Package terminaloutput represents the imported interface "wasi:cli/terminal-output@0.2.3".
...
// TerminalOutput represents the imported resource "wasi:cli/terminal-output@0.2.3#terminal-output".
//
