...
// Package terminalstdin represents the imported interface "wasi:cli/terminal-stdin@0.2.3".
package terminalstdin

import (
	terminalinput "adder-wasm-bindings/internal/wasi/cli/terminal-input"
	"go.bytecodealliance.org/cm"
)

// TerminalInput represents the imported type alias "wasi:cli/terminal-stdin@0.2.3#terminal-input".
//
